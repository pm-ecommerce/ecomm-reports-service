...
public interface ProductRepository extends JpaRepository<Product, Integer> {
    ...
    @Query(value = "SELECT count(distinct o.id), sum(i.quantity*i.rate) " +
            ...
            "     GROUP BY p.id "
            , nativeQuery = true)
    public List<Object[]> findProductByReportRequestWithoutGroupBy(@Param("vendorId") String vendorId);
    ...
    @Query(value = "SELECT EXTRACT(YEAR FROM o.delivery_date), count(distinct p.id), sum(i.quantity*i.rate) " +
            ...
            , nativeQuery = true)
    public List<Object[]> findProductByReportRequestWithGroupByYear(@Param("vendorId") String vendorId);
    ...
    @Query(value = "SELECT DATE_FORMAT(o.delivery_date, '%Y %b') as month, count(distinct p.id), sum(i.quantity*i.rate) " +
            ...
            "    GROUP BY month "
            , nativeQuery = true)
    public List<Object[]> findProductByReportRequestWithGroupByYearMonth(@Param("vendorId") String vendorId);
    ...
    @Query(value = "SELECT DATE_FORMAT(o.delivery_date, '%Y %b %e') as week , count(distinct p.id), sum(i.quantity*i.rate) " +
            ...
            "    GROUP BY week "
            , nativeQuery = true)
    public List<Object[]> findProductByReportRequestWithGroupByWeek(@Param("vendorId") String vendorId);
    ...
    @Query(value = "SELECT EXTRACT(DAY FROM o.delivery_date), count(distinct p.id), sum(i.quantity*i.rate) " +
            ...
            , nativeQuery = true)
    public List<Object[]> findProductByReportRequestWithGroupByDay(@Param("vendorId") String vendorId);
